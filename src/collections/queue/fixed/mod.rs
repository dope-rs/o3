...
impl<T> Coalescing<T> {
    ...
    pub fn try_with_capacity(capacity: u32) -> Result<Self, crate::collections::AllocationError> {
    ...
    I: raw::Index,
{
    ...
    pub fn schedule(&mut self, index: I, value: T) -> Result<(), T> {
        ...
        unsafe { raw::Coalescing::schedule_unchecked(self, index, value) };
        Ok(())
    }
...
impl<T> Fifo<T> {
    ...
    pub fn try_with_capacity(capacity: usize) -> Result<Self, crate::collections::AllocationError> {
        ...
        Ok(Self {
            ring: Ring {
                entries: crate::collections::try_box_uninit(capacity)?,
                head: 0,
                len: 0,
